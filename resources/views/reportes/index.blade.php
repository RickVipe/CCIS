...
<div class="row">
    <div class="col-lg-12">
    	<h3 class="page-header">Lista de Alumnos</h3>
    </div>
</div>
<!-- /.row -->
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="">
            <form role="form" class="form" action="/menucoordinadores/reportes/listado" method="post">
              ...
              <button type="submit" class="btn btn-success" value = 'listar' name='submit_button'>Ver Lista de Alumnos</button>
