            ...
            <div class="col-lg-6">
              <form role="form" method="post" action="/menucoordinadores/salon_horario" autocomplete="off">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="nro_salon" >
                </div>
                ...
                <button type="button" class="btn btn-danger" onClick="location.href='/menucoordinadores/salon_horario/{!! $curso->first()->id !!}'">Volver</button>
              </form>
            </div>
