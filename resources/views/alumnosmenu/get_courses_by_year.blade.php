...
<div class="row">
  <div class="col-lg-12">
        ...
        <div class="dataTable_wrapper">
          ...
          @if($cursos->isEmpty())
            <div class="alert alert-success">
              ...
              No ha seleccionado ningun per&iacute;odo <a href="/menualumnos/miscursos" class="alert-link">Seleccionar Per&iacute;odo</a>.
            </div>
          @else
    ...
    <button type="button" class="btn btn-danger" onclick="location.href='/menualumnos/miscursos'">Volver</button><br><br>
  </div>
</div>
@stop
