...
<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header"> Lista de Cursos @if($anio != '') - Per&iacute;odo escolar {!! $anio !!} @endif
    </h3>
  </div>
...
<div class="row">
        ...
        <div class="dataTable_wrapper">
          ...
          @if($cursos->isEmpty())
            ...
            <div class="alert alert-success">
              ...
              No ha seleccionado ningun per&iacute;odo <a href="/menudocentes/filtrar" class="alert-link">Seleccionar Per&iacute;odo</a>.
            </div>
                  ...
                  <ul class="nav nav-pills">
                    <li>
                      <form method="get" action="{!! action('DocenteMenuController@recuperarAlumnosxCurso' , [$curso->id_grado, $curso->idasignatura]) !!}">
                        <div>
                          <button type="submit" class="btn btn-success" title="Listar Alumnos">
  ...
  onclick="location.href='/menudocentes/filtrar'">Volver</button><br><br>
</div>
</div>
