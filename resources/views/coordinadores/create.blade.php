  ...
  <div class="col-lg-12">
    <div class="panel panel-info">
      <div class="panel-heading">
        Ingrese los datos del Coordinador
      </div>
      <div class="panel-body">
        <div class="row">
          <div class="col-lg-6">
            <form action="/menucoordinadores/coordinadores"  role='form' method="post" autocomplete="off">
            ...
            <button type="button" class="btn btn-danger" onClick="location.href='{!! action('CoordinadorController@index2') !!}'">Volver</button>
            </form>
          </div>
        </div>
      </div>
